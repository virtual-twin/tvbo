...
| BSB | https://github.com/BlueBrain/BSB | scaffold‑builder | `cortical`, `network_system` | `multi‑scale_scaffold` | `workflow_framework` | `Python`, `C++` | `MPI`, `BluePyOpt` | `tvbo:tvb`, `tvbo:neuron`, `tvbo:nest` | `Apache‑2.0` |
