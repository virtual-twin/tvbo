...
| [tree_flatten](#tvbo.classes.network.Network.tree_flatten) | Flatten into JAX pytree children `(weights, lengths)` plus metadata aux data. |
| [tree_unflatten](#tvbo.classes.network.Network.tree_unflatten) | Rebuild a `Network` from JAX pytree children and metadata (inverse of `tree_flatten`). |
