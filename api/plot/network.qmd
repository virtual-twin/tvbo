...
| Name | Description |
| --- | --- |
| [plot_graph_brain](#tvbo.plot.network.plot_graph_brain) | Render a network on the cortical brain surface using ``bsplot``. |
| [plot_graph_bsplot](#tvbo.plot.network.plot_graph_bsplot) | Render a network graph with bsplot text-box nodes and curved edges. |
| [plot_graph_networkx](#tvbo.plot.network.plot_graph_networkx) | Render a network graph with standard NetworkX drawing. |

### plot_graph_brain { #tvbo.plot.network.plot_graph_brain }

```python
plot.network.plot_graph_brain(
    network,
    *,
    ax=None,
    weight_matrix=None,
...
### plot_graph_bsplot { #tvbo.plot.network.plot_graph_bsplot }

```python
plot.network.plot_graph_bsplot(
    G,
    *,
    ax=None,
    node_cmap='viridis',
...
### plot_graph_networkx { #tvbo.plot.network.plot_graph_networkx }

```python
plot.network.plot_graph_networkx(
    G,
    *,
    ax=None,
    node_cmap='viridis',
