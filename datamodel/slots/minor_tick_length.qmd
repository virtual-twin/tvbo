# Slot: minor_tick_length 


_Length of a minor tick mark, in points. Ignored unless `minor_ticks` is set._
...
URI: [tvbo:slot/minor_tick_length](https://w3id.org/tvbo/slot/minor_tick_length)
...
| ---  | ---  |
| self | tvbo:minor_tick_length |
| native | tvbo:minor_tick_length |
