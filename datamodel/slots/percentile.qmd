...
_Clip the limit to this percentile of the values (100 = no clipping), so one outlier region cannot wash the whole map out. Applies whether or not the scale is centred._
...
URI: [tvbo:slot/percentile](https://w3id.org/tvbo/slot/percentile)
...
| ---  | ---  |
| self | tvbo:percentile |
| native | tvbo:percentile |
...
description: Clip the limit to this percentile of the values (100 = no clipping),
  so one outlier region cannot wash the whole map out. Applies whether or not the
  scale is centred.
