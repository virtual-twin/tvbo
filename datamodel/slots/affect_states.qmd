...
_State variable symbols modifiable in the affect function._
...
URI: [tvbo:slot/affect_states](https://w3id.org/tvbo/slot/affect_states)
...
| ---  | ---  |
| self | tvbo:affect_states |
| native | tvbo:affect_states |
