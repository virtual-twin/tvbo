...
class TestSurvivesMerge:
    ...
    def test_enrichment_lands_on_the_struct_identity(self, merged, value):
        ...
        The value must keep its struct-provided identity (subClassOf the enum, a skos:definition) AND carry the merged-in backendParameter — proof the module enriched the existing IRI instead of minting a duplicate.
        """
