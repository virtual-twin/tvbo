...
These tests compare the numerical output of TVBO's NetworkDynamics.jl code generation + execution against pre-computed reference data from the original NetworkDynamics.jl tutorials.
...
class TestNumericalComparison:
    ...
    def julia_runner(self):
        ...
        from tvbo.run.julia import extract_ode_solution, run_julia_code
