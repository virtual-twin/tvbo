...
class TestNumericalComparison:
    ...
    Starting Julia inside a forked xdist worker kills the worker rather than failing
    the test, and the classes above it here need no Julia at all — so the fact has to
    live on this class, where it is true, rather than as a path in a CI shard's
    ignore list.
    """
