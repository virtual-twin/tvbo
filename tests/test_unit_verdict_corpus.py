...
106 registered models declare no unit anywhere, and 103 have no equation the
checker can settle either way — which is why it reports three answers instead of
two. A gate demanding consistency of all 106 would pressure invented declarations
