...
aliases:
  - /Models/DefineDynamicalSystem.html
...
pendulum = SimulationExperiment(
    ...
    # This pendulum swings with a period near 630 ms, so 0.1 ms resolves it finely. Left unset the step defaults to 0.0122 ms, which is sized for neural masses and puts fifty thousand steps in every swing.
    integration=Integrator(step_size=0.1),
)
