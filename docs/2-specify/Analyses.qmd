...
- [Linked experiments in a SimulationStudy](SimulationStudies.qmd): where `analyses:` is declared.
- [Calling your own code](CodeSource.qmd): how `module:` resolves.
- [Specify a figure](Figures/index.qmd): the consumer that binds an analysis with `used:`.
