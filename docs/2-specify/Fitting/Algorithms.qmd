...
- [Model Fitting](/2-specify/Fitting/ModelFitting.qmd): gradient optimization after tuning
- [EI Tuning tvboptim workflow](/examples/fitting/EI_Tuning_tvboptim.qmd): complete FIC+EIB example
