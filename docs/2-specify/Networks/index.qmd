...
|---|---|---|
| [Network specification](Network.qmd) | The `Network` spec itself: constructors, storage format, and the built-in connectome catalogue. | fa-solid fa-circle-nodes |
...
| Page | What it covers | Cover |
|---|---|---|
| [Coupling functions](CouplingFunctions.qmd) | The rule that turns one node's state into the signal its neighbours receive. | ![](../../_static/thumbs/2-specify-Networks-CouplingFunctions.png) |
:::
...
For a region with genuine internal structure rather than different parameters, see [Beyond the mean field](../Models/BeyondMeanField/index.qmd).
