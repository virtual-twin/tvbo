...
| `figures[].panels[].callable` | A [bespoke panel](Figures/custom-panels.qmd) the figure grammar cannot draw. |
...
- [Linked experiments in a SimulationStudy](SimulationStudies.qmd): where `code_source` and `requires` are declared.
