...
| [NetworkDynamics.jl](NetworkDynamics.jl/index.qmd) | SimulationExperiment + Network | Export | Julia graph-based network simulation |
...
| Integration | Input | Direction | Description |
|-------------|-------|-----------|-------------|
| [PyRates](Pyrates/index.qmd) | SimulationExperiment or Dynamics | Bidirectional | Dynamical systems analysis and simulation |
| [BifurcationKit.jl](BifurcationKit.jl/index.qmd) | Dynamics + Continuation | Export | Julia bifurcation analysis (equilibria, Hopf, periodic orbits) |
...
| Integration | Input | Direction | Description |
|-------------|-------|-----------|-------------|
| [BIDS](BIDS/index.qmd) | SimulationExperiment | Export | Brain Imaging Data Structure (BEP034) |
| [OpenMINDS](OpenMINDS.qmd) | SimulationExperiment | Bidirectional | EBRAINS Knowledge Graph metadata (JSON-LD) |
| NeuroML / LEMS | Dynamics | Export | LEMS ComponentType definitions |
