...
This example replicates [COModel.jl](https://github.com/bifurcationkit/BifurcationKit.jl/blob/master/examples/COModel.jl) from BifurcationKit.jl, modeling catalytic CO oxidation on a platinum surface.
