...
description: "Instance-based population with explicit cell placement"
---

## Model: Instance-Based Population

Explicit instance placement in NeuroML2 — each cell has specific 3D coordinates.
The cell dynamics are the same IaF model as Ex0/Ex12.
...
label: "NeuroML Ex13: IaF Cell (Instances)"
dynamics:
