...
Three iafCells: one source driven by pulse generators, connected to two targets via graded (analog) synapses — a `linearGradedSynapse` and a voltage-dependent `gradedSynapse`.
