...
Current-based synapses inject a fixed current waveform on spike arrival,
as opposed to conductance-based synapses where current depends on driving force.
...
Synaptic models (`alphaCurrSynapse`, `expCurrSynapse`) are NeuroML-native network
features.  TVBO represents the cell dynamics; synaptic kinetics are handled
by the NeuroML adapter.
:::
