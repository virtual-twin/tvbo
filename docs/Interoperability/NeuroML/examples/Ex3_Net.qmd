...
on network edges.  The simulated traces match the reference jNeuroML simulation to
correlation r ≈ 1; the emitted XML is equivalent, not byte-identical, to the canonical
NeuroML file.
