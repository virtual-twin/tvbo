...
ax.plot(t_tvbo, driver_tvbo.data.values.squeeze(), 'k--', lw=1.5, alpha=0.7, label="TVBO TimeSeries")
...
ax.plot(t_tvbo, excitable_tvbo.data.values.squeeze(), 'k--', lw=1.5, alpha=0.7, label="TVBO TimeSeries")
ax.axhline(0, color='gray', ls='--', alpha=0.5)
...
ax.plot(t_tvbo, relaxation_tvbo.data.values.squeeze(), 'k--', lw=1.5, alpha=0.7, label="TVBO TimeSeries")
ax.axhline(0, color='gray', ls='--', alpha=0.5)
