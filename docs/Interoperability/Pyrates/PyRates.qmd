...
result = exp.run().integration.main
...
result = synapse_exp.run().integration.main

# Plot synaptic dynamics
fig, axes = plt.subplots(1, 3, figsize=(14, 4))

time = result.time
x = result.data[:, 0, 0]  # synaptic resources
u = result.data[:, 1, 0]  # utilization factor
...
tvbo_result = exp_compare.run().integration.main
...
# Compare
tvbo_x = tvbo_result.data[:, 0, 0]
tvbo_z = tvbo_result.data[:, 1, 0]
