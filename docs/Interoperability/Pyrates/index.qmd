...
[PyRates](https://pyrates.readthedocs.io/) is a Python framework for numerical simulation and analysis of dynamical systems. TVBO provides full round-trip interoperability:
...
- [TVB-O Model Database](../../browser.qmd)
