...
| Original ND.jl Tutorial | Missing Feature |
|--------------------------|----------------|
| [Gas Network](https://juliadynamics.github.io/NetworkDynamics.jl/stable/generated/gas_network/) | ModelingToolkit.jl `@mtkmodel` equation-based modeling |
| [Initialization Tutorial](https://juliadynamics.github.io/NetworkDynamics.jl/stable/generated/init_tutorial/) | ModelingToolkit.jl `@mtkmodel`, `find_fixpoint()` steady-state initialization, two-phase static→dynamic init |
