...
# space is keyed by the dotted parameter, so each axis is a direct lookup
_space = exp.explorations["frequency_landscape"].space
n1 = _space["JansenRit.a"].domain.n
n2 = _space["JansenRit.b"].domain.n
im = ax.imshow(
