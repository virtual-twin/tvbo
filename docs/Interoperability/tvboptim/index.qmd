...
| [Bayesian Inference](Bayesian_tvboptim.qmd) | Generic2dOscillator | numpyro MCMC; recover stimulus + excitability |
| [Delays Shape Synchronization](Delay_Speed_Synchronization_tvboptim.qmd) | Kuramoto | Conduction-speed sweep of delay-organized synchronization; differentiable delays via `DenseLengthGraph` |
