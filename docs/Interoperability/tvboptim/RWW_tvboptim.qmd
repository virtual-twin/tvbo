...
results = exp.run("tvboptim", empirical_fc=fc_target)
...
ax.scatter(
    [s.coupling.FastLinearCoupling.G.value for s in route][::2],
...
ax.set(xlabel="G", ylabel="w", title="Parameter Landscape")

# D-F: FC Matrices
for key, fc, title in [
    ("D", np.array(fc_global), f"Global"),
    ("E", np.array(fc_regional), f"Regional"),
