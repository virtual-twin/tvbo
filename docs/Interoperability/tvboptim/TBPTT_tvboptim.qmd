...
a = ax["R"]
a.plot(G, np.abs(fd_G) + 1e-12, "x--", color=INK, lw=1.5, ms=5, label="Finite difference (ground truth)")
a.plot(G, np.abs(ad_G) + 1e-12, "o", color=ACCENT, ms=5, label="Autodiff  |dL/dG|")
a.set_yscale("log")
