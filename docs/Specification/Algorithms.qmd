...
- [Model Fitting](/Fitting/ModelFitting.qmd): gradient optimization after tuning
- [EI Tuning tvboptim workflow](/Fitting/EI_Tuning_tvboptim.qmd): complete FIC+EIB example
