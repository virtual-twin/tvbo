...
- [Linked experiments in a SimulationStudy](../Simulation/SimulationStudies.qmd): the object a fanned experiment sits in.
- [Distributed workflows](../ScaleOut/DistributedWorkflows.qmd): how shards become cluster jobs.
- [Observation models](../Simulation/ObservationModels.qmd): what `source:` and `pipeline:` can express.
