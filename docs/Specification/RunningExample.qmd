...
Documented by [The SimulationExperiment](../Simulation/SimulationExperiments.qmd) and [Dynamical systems](../Models/index.qmd).
...
Documented by [Observation models](../Simulation/ObservationModels.qmd) and [Output specification](Output.qmd).
...
Documented by [Parameter exploration](../Simulation/ParameterExploration.qmd).
...
Documented by [Network specification](Network.qmd) and [Coupling functions](../Networks/CouplingFunctions.qmd).
...
A paper is not one experiment. A [SimulationStudy](../Simulation/SimulationStudies.qmd) holds several, shares blocks between them with YAML anchors, and declares the analyses and figures that turn results into the thing you publish.

Documented by [Linked experiments in a SimulationStudy](../Simulation/SimulationStudies.qmd), [Analyses](Analyses.qmd), [Specify a figure](../Simulation/Figures.qmd) and [Writing TVB-O YAML](YAML.qmd).
...
|---|---|---|
| 1 | `dynamics`, `network`, `integration` | [The SimulationExperiment](../Simulation/SimulationExperiments.qmd) |
| 2 | `observations` | [Observation models](../Simulation/ObservationModels.qmd), [Output specification](Output.qmd) |
| 3 | `integration.noise` | [Noise & stochastic integration](../Models/Noise.qmd) |
| 4 | `explorations`, `record` | [Parameter exploration](../Simulation/ParameterExploration.qmd) |
| 5 | `network.iri`, `transforms`, `coupling` | [Network specification](Network.qmd), [Coupling functions](../Networks/CouplingFunctions.qmd) |
| 6 | `experiments`, `analyses`, `figures` | [SimulationStudy](../Simulation/SimulationStudies.qmd), [Analyses](Analyses.qmd), [Figures](../Simulation/Figures.qmd) |

The blocks this thread never needed slot in the same way and are documented the same way: [events and stimulation](../Models/Events.qmd), [fan-out over subjects](FanOut.qmd), [calling your own code](CodeSource.qmd), [algorithms](Algorithms.qmd) and [loss functions](LossFunction.qmd).
