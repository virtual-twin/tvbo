...
| [Events & stimulation](Events.qmd) | Threshold events, preset-time events, and external stimuli. | ![](../_static/thumbs/Models-Events.png) |
...
| Page | What it covers | Cover |
|---|---|---|
| [Integrators](Integrators.qmd) | The available methods, and when each one is the right choice. | fa-solid fa-timeline |
| [Cross-backend numerical parity](CrossBackendParity.qmd) | Why two backends can disagree about the same model, and the four things that break parity. | fa-solid fa-scale-balanced |
:::
