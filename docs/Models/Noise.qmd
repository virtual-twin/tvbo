...
This pattern, plus stripping `integration.noise`, gives bit-comparable output across backends — see [Cross-Backend Numerical Parity](CrossBackendParity.qmd).

## See Also

- [Cross-Backend Numerical Parity](CrossBackendParity.qmd): running the same experiment on `tvboptim`, `jax`, and `tvb` and verifying agreement.
