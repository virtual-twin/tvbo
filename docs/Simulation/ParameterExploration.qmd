...
::: {.callout-tip}
## Grids grow fast
`mode: product` multiplies. Three axes of 10 points is 1000 simulations. Start coarse, find the interesting region, then refine — and move large grids to a cluster with [`tvbo workflow`](../CLI/workflow.qmd) and the [HPC patterns](../CLI/hpc.qmd) rather than running them locally.
:::

## Where to go next

- **Found an interesting region?** [Bifurcation analysis](../Bifurcation/index.qmd) characterizes *what* changes there, instead of only where.
