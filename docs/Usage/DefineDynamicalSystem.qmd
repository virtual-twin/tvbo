...
This guide demonstrates how to define and simulate dynamical systems using TVBO's specification language.
...
ani.save("_output/pendulum_animation.html", writer="html")

# Display saved animation
from IPython.display import IFrame
IFrame("_output/pendulum_animation.html", width=700, height=300)
```
