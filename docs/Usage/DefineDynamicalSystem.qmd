...
Define the pendulum [Dynamics](/datamodel/classes/Dynamics.html) using YAML format with [Parameter](/datamodel/classes/Parameter.html)s, [state variables](/datamodel/classes/StateVariable.html), and [output transforms](/datamodel/slots/output_transforms.html):
...
- **Parameters**: Physical constants (damping, frequency, length)
- **State variables**: Time-evolving quantities (angle θ, angular velocity ω)
- **Output transforms**: Computed observables (Cartesian coordinates x, y)
