...
ax.plot(t, pre_r.data.values.squeeze(), 'k', lw=2, label="Pre-synaptic Rate")
...
ax.plot(t, dep_x.data.values.squeeze(), 'C0', lw=2, label="Depression (x)")
ax.plot(t, fac_u.data.values.squeeze(), 'C1', lw=2, label="Facilitation (u)")
ax.plot(t, tso_x.data.values.squeeze(), 'C2', lw=2, label="Tsodyks x")
ax.plot(t, tso_u.data.values.squeeze(), 'C3', lw=2, label="Tsodyks u")
...
ax.plot(t, post_r.data.values.squeeze(), 'C4', lw=2, label="Post-synaptic Rate")
