...
- [Observation Models](ObservationModels.qmd) — define BOLD, FC pipelines
...
- [RWW tvboptim workflow](/Interoperability/tvboptim/RWW_tvboptim.qmd) — complete FC-matching example
