...
aliases:
  - /How-To/BuildConnectomeFromTractography.html
---
...
contain finer detail, see [Model Across Scales](../BeyondMeanField/MultiScaleModelling.qmd).
...
- [Hierarchical & surface networks](HierarchicalSurfaceNetworks.qmd): add a
  surface mesh layer on top of this regional connectome, reusing the atlas built
  in Step 1.
- [Model Across Scales](../BeyondMeanField/MultiScaleModelling.qmd): give selected regions a
