...
If you already have connectivity matrices and only need to wrap them, skip to [Defining Networks](../Specification/Network.qmd). For a network whose regions contain finer detail, see [Model Across Scales](../BeyondMeanField/MultiScaleModelling.qmd).
...
- [Model Across Scales](../BeyondMeanField/MultiScaleModelling.qmd): give selected regions a detailed spiking or reservoir patch.
