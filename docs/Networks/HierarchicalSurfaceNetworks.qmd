...
- To wrap connectivity matrices you already have, or load a built-in connectome, see [Defining Networks](../Specification/Network.qmd).
- To give regions a detailed spiking or reservoir patch, see [Model Across Scales](../BeyondMeanField/MultiScaleModelling.qmd).
