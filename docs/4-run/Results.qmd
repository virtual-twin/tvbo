...
`ExperimentResult.export()` writes simulation data and experiment metadata to a [BIDS](https://bids-specification.readthedocs.io/)-compatible directory following
...
- [Simulation Experiments](../2-specify/SimulationExperiments.qmd): defining and running experiments
- [Observation Models](../2-specify/Observation/index.qmd): derived observables (BOLD, FC, …)
- [Plot a result directly](../2-specify/Figures/Visualization.qmd): the built-in plots, and [Figures](../2-specify/Figures/index.qmd) for the declarative ones
