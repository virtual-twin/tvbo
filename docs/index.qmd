...
`tvbo` is a Python library for defining, simulating, and analyzing dynamical systems in computational neuroscience. Built on The Virtual Brain (TVB) framework, it combines ontology-driven knowledge representation with flexible simulation capabilities.
