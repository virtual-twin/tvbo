...
`_static/phases.yml` declares the five numbered phases and the five unnumbered chapters, each with a name, an icon and a colour. It is the only place any of those are written down, so swapping an icon set is one edit here.
