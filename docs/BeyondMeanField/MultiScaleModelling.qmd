...
- [Multi-scale co-simulation](../Specification/Network.qmd#multi-scale-co-simulation), including the proxy pattern, interface variables, and how the same file maps to tvb-multiscale, JAX, and NeuroML backends
- schema slots
