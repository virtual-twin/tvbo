...
For reference, the same six values rendered as a static grid using `kind='phaseplane'`:
...
![A limit cycle being born as the bifurcation parameter crosses the Hopf point: the fixed point loses stability and trajectories spiral out onto a growing closed orbit.](hopf_sweep.gif)
