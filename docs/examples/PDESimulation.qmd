...
- [Simulation Experiments](../2-specify/SimulationExperiments.qmd): the `'pde'` backend
- [Code Generation & Export](../3-generate/CodeGeneration.qmd) — `render_code('pde')`
