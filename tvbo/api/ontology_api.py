...
def uid2int(uid):
    ...
    Args:
        uid: The UID annotation to read.
...
def ontoclass2dict(ontoclass):
    ...
    Args:
        ontoclass: The ontology class to convert.
...
class OntologyAPI:
    ...
    def search_by_term(self, term="JansenRit", node2str=True):
        ...
        Args:
            term: Search text, or a storid.
            node2str: Unused; kept for the front end's call signature.
    ...
    def query_nodes(self, query_str="noise"):
        ...
        Args:
            query_str: Label text to search for.
        """
        self.__init__()
    ...
    def get_child_connections(self, node_id):
        ...
        Args:
            node_id: Storid of the node to expand.
    ...
    def export_experiment(
        ...
        **kwargs,
        ...
        Args:
            format: Export format name or alias.
            directory: Where to write; created if absent.
            metadata_only: Write the specification alone, without the network payload.
