#
# Module: behaviour/software.py
#
# Author: Leon Martin
# Copyright © 2024 Charité Universitätsmedizin Berlin.
# Licensed under the EUPL-1.2-or-later
#
"""What a ``SimulationTool`` database entry does: its factory constructors, and its own unit vocabulary.
...
class SimulationToolBehaviour:
    ...
    def _unit_entry(self, unit):
        """This tool's entry for *unit*, or ``None`` when it declares none."""
