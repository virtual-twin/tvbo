...
From YAML string:
    ...
    from tvbo.export.functions import generate_function, generate_loss_function
    from linkml_runtime.loaders import yaml_loader
    from tvbo.datamodel.tvbo_datamodel import Function, LossFunction
...
From Function object directly:
    ...
    from tvbo.datamodel.tvbo_datamodel import Function, Equation, Argument
...
def generate_function(
    ...
    Examples
    --------
    >>> from tvbo.datamodel.tvbo_datamodel import Function, Equation
    >>> func = Function(
    ...     name='sigmoid',
...
def generate_loss_function(
    ...
    Examples
    --------
    >>> from tvbo.datamodel.tvbo_datamodel import LossFunction, Equation, Aggregation
    >>> loss = LossFunction(
    ...     name='spectral_loss',
