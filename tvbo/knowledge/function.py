...
class Function(tvbo_datamodel.Function):
    ...
    def render_code(
        ...
        from tvbo.export.functions import generate_function
    ...
    def to_callable(
        ...
        """
        # Lazy import to avoid circular dependency
        from tvbo.export.functions import function_to_callable
...
class LossFunction(tvbo_datamodel.LossFunction):
    ...
    def render_code(
        ...
        """
        # Lazy import to avoid circular dependency
        from tvbo.export.functions import generate_loss_function
