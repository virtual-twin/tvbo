...
class ExplorationAxis(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'tvbo:ExplorationAxis',
         'from_schema': 'https://w3id.org/tvbo',
         'slot_usage': {'name': {'description': 'Optional axis label (defaults to the '
                                                'dotted parameter reference).',
                                 'name': 'name',
                                 'required': False}}})

    name: str = Field(default=..., description="""Optional axis label (defaults to the dotted parameter reference).""", json_schema_extra = { "linkml_meta": {'domain_of': ['BrainAtlas',
                       'CommonCoordinateSpace',
                       'ParcellationEntity',
                       'DBSProtocol',
                       'ClinicalScale',
...
class FreeParameter(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'tvbo:FreeParameter',
         'from_schema': 'https://w3id.org/tvbo',
         'slot_usage': {'name': {'description': 'Optional label (defaults to the '
                                                'dotted parameter reference).',
                                 'name': 'name',
                                 'required': False}}})

    name: str = Field(default=..., description="""Optional label (defaults to the dotted parameter reference).""", json_schema_extra = { "linkml_meta": {'domain_of': ['BrainAtlas',
                       'CommonCoordinateSpace',
                       'ParcellationEntity',
                       'DBSProtocol',
                       'ClinicalScale',
