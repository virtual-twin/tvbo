...
linkml_meta = LinkMLMeta(
    {
        ...
        "prefixes": {
            ...
            "biotools": {"prefix_prefix": "biotools", "prefix_reference": "https://bio.tools/ontology/"},
            ...
            "qudt": {"prefix_prefix": "qudt", "prefix_reference": "http://qudt.org/vocab/unit/"},
            ...
            "tvbo": {"prefix_prefix": "tvbo", "prefix_reference": "http://www.thevirtualbrain.org/tvb-o/"},
            "wd": {"prefix_prefix": "wd", "prefix_reference": "http://www.wikidata.org/entity/"},
        },
...
class Coordinate(ConfiguredBaseModel):
    ...
    coordinateSpace: Optional[str] = Field(
        default=None,
        description="""Add the common coordinate space used for this brain atlas version.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Coordinate", "BrainAtlas"]}},
    )
    x: Optional[float] = Field(
        default=None,
        description="""X coordinate""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Coordinate", "Matrix"]}},
    )
    ...
    z: Optional[float] = Field(
        default=None, description="""Z coordinate""", json_schema_extra={"linkml_meta": {"domain_of": ["Coordinate"]}}
    )
...
class BrainAtlas(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "atom:atlas/Atlas", "from_schema": "https://openminds.ebrains.eu/sands/BrainAtlas"}
    )
    ...
    abbreviation: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["BrainAtlas", "CommonCoordinateSpace", "ParcellationEntity"]}},
    )
    author: Optional[list[str]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["BrainAtlas", "SimulationTool"]}}
    )
    isVersionOf: Optional[str] = Field(
        default=None,
        description="""Linked type for the version of a brain atlas or coordinate space.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["BrainAtlas"],
                "union_of": ["BrainAtlas", "CommonCoordinateSpace", "ParcellationTerminology", "ParcellationEntity"],
            }
        },
    )
    versionIdentifier: Optional[str] = Field(
        default=None,
        description="""Enter the version identifier of this brain atlas or coordinate space version.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BrainAtlas", "ParcellationEntity", "ParcellationTerminology"]}},
    )
    terminology: Optional[ParcellationTerminology] = Field(
        default=None,
        description="""Add the parcellation terminology version used for this brain atlas version.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BrainAtlas"]}},
    )
...
class CommonCoordinateSpace(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "atom:atlas/Transformation", "from_schema": "https://openminds.ebrains.eu/sands/BrainAtlas"}
    )
    ...
    unit: Optional[UnitEnum] = Field(
        default=None,
        description="""Physical unit of measurement. Values are drawn from the QUDT ontology (http://qudt.org/vocab/unit/) with UO cross-references where available.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": [
                    "CommonCoordinateSpace",
    ...
    license: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["CommonCoordinateSpace", "SoftwarePackage", "SoftwareRequirement", "Provenance"]}
        },
    )
    anatomicalAxesOrientation: Optional[str] = Field(
        default=None,
        description="""Add the axes orientation in standard anatomical terms (XYZ).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["CommonCoordinateSpace"]}},
    )
    axesOrigin: Optional[str] = Field(
        default=None,
        description="""Enter the origin (central point where all axes intersect).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["CommonCoordinateSpace"]}},
    )
    nativeUnit: Optional[str] = Field(
        default=None,
        description="""Add the native unit that is used for this common coordinate space version.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["CommonCoordinateSpace"]}},
    )
    defaultImage: Optional[list[str]] = Field(
        default=None,
...
class ParcellationEntity(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "categories": ["anatomicalLocation", "studyTarget"],
    ...
    alternateName: Optional[list[str]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity"], "slot_uri": "atom:atlas/hasName"}},
    )
    lookupLabel: Optional[int] = Field(
        default=None,
        description="""Enter the label used for looking up this entity in the parcellation terminology.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity"], "slot_uri": "atom:atlas/lookupLabel"}},
    )
    hasParent: Optional[list[str]] = Field(
        default=None,
        description="""Add all anatomical parent structures for this entity as defined within the corresponding brain atlas.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity"], "slot_uri": "atom:atlas/hasParent"}},
    )
    name: str = Field(
        default=...,
        json_schema_extra={
    ...
    ontologyIdentifier: Optional[list[str]] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["ParcellationEntity", "ParcellationTerminology"], "slot_uri": "atom:atlas/hasIlxId"}
        },
    )
    versionIdentifier: Optional[str] = Field(
        default=None,
    ...
    relatedUBERONTerm: Optional[str] = Field(
        default=None,
        description="""Add the related anatomical entity as defined by the UBERON ontology.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity"]}},
    )
    originalLookupLabel: Optional[int] = Field(
        default=None,
        description="""Add the original label of this entity as defined in the parcellation terminology.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity"]}},
    )
    hemisphere: Optional[Hemisphere] = Field(
        default=None,
        description="""Add the hemisphere of this entity.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity", "Electrode"]}},
    )
    center: Optional[Coordinate] = Field(
        default=None,
...
class ParcellationTerminology(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "atom:parcellationTerminology", "from_schema": "https://openminds.ebrains.eu/sands/BrainAtlas"}
    )
    ...
    entities: Optional[dict[str, ParcellationEntity]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationTerminology"]}}
    )
...
class Subject(ConfiguredBaseModel):
    ...
    subject_id: str = Field(
        default=...,
        description="""BIDS-compatible subject identifier (without 'sub-' prefix). Examples: '01', 'ctrl03', 'patient17'.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject", "TimeSeries"], "exact_mappings": ["schema:identifier"]}},
    )
    label: Optional[str] = Field(
        default=None,
    ...
    group: Optional[str] = Field(
        default=None,
        description="""Group assignment (e.g., 'control', 'patient', 'healthy'). Maps to participants.tsv 'group' column in BIDS.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject"]}},
    )
    ...
    sex: Optional[SexEnum] = Field(
        default=None, description="""Biological sex.""", json_schema_extra={"linkml_meta": {"domain_of": ["Subject"]}}
    )
    sessions: Optional[dict[str, Session]] = Field(
        default=None,
        description="""Data collection sessions for this subject. Each session can have its own network, empirical data, and conditions.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject"]}},
    )
    network: Optional[str] = Field(
        default=None,
        description="""Path to subject-specific connectome (when not session-dependent). Relative to dataset root or BIDS derivatives. For session-specific networks, use Session.network instead.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject", "Session", "SimulationExperiment"]}},
    )
    metadata: Optional[str] = Field(
        default=None,
        description="""Additional subject metadata as key-value pairs or path to a sidecar JSON file.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject"]}},
    )
...
class Session(ConfiguredBaseModel):
    ...
    session_id: str = Field(
        default=...,
        description="""BIDS session identifier (without 'ses-' prefix). Examples: 'baseline', '6month', 'pre', 'post'.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Session", "TimeSeries"]}},
    )
    label: Optional[str] = Field(
        default=None,
    ...
    network: Optional[str] = Field(
        default=None,
        description="""Path to session-specific connectome. Overrides Subject.network when set. Relative to dataset root or BIDS derivatives.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject", "Session", "SimulationExperiment"]}},
    )
    empirical_data: Optional[list[str]] = Field(
        default=None,
        description="""Paths to empirical recordings for this session (e.g., BOLD time series, MEG/EEG). Relative to dataset root.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Session"]}},
    )
    condition: Optional[str] = Field(
        default=None,
        description="""Experimental condition label (e.g., 'rest', 'task-nback'). Maps to BIDS 'task-' entity.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Session", "ConditionalBlock", "Event", "Case"]}},
    )
...
class Dataset(ConfiguredBaseModel):
    ...
    dataset_id: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Dataset"]}},
    )
    label: Optional[str] = Field(
        default=None,
    ...
    bids_root: Optional[str] = Field(
        default=None,
        description="""Path to BIDS dataset root directory. When set, subject networks and empirical data paths are resolved relative to this root.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dataset"]}},
    )
    subjects: Optional[dict[str, Subject]] = Field(
        default=None,
    ...
    conditions: Optional[list[str]] = Field(
        default=None,
        description="""Global condition labels applied across all subjects (e.g., ['rest', 'task-nback', 'task-motor']).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dataset"]}},
    )
    reference: Optional[str] = Field(
        default=None,
        description="""DOI or citation for this dataset.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dataset", "ClinicalScale", "ClinicalScore", "Tractogram"]}},
    )
...
class DBSDataset(Dataset):
    ...
    clinical_scores: Optional[list[ClinicalScore]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["DBSDataset"]}}
    )
    coordinate_space: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["DBSDataset", "DBSSubject", "Electrode", "EField", "Network", "SpatialDomain", "Mesh"]
            }
        },
    )
    dataset_id: str = Field(
    ...
    subjects: Optional[dict[str, DBSSubject]] = Field(
        default=None,
        description="""Subjects in this dataset.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dataset"]}},
    )
...
class DBSSubject(Subject):
    ...
    protocols: Optional[list[str]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DBSSubject"]}},
    )
    coordinate_space: Optional[str] = Field(
        default=None,
...
class Electrode(ConfiguredBaseModel):
    ...
    electrode_id: Optional[str] = Field(
        default=None,
    ...
    model: Optional[str] = Field(
        default=None,
        json_schema_extra={"linkml_meta": {"domain_of": ["Electrode", "SimulationExperiment", "SimulationStudy"]}},
    )
    hemisphere: Optional[str] = Field(
        default="left",
        description="""Hemisphere of electrode (left/right)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ParcellationEntity", "Electrode"], "ifabsent": "left"}},
    )
    ...
    trajectory: Optional[list[Coordinate]] = Field(
        default=None,
        description="""The planned trajectory for electrode implantation""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Electrode"]}},
    )
    target_structure: Optional[str] = Field(
        default=None,
...
class Contact(ConfiguredBaseModel):
    ...
    contact_id: Optional[int] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Contact"]}},
    )
...
class StimulationSetting(ConfiguredBaseModel):
    ...
    electrode_reference: Optional[Electrode] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["StimulationSetting"]}}
    )
    ...
    mode: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["StimulationSetting", "Exploration"]}}
    )
    active_contacts: Optional[list[int]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["StimulationSetting"]}}
    )
    efield: Optional[EField] = Field(
        default=None,
        description="""Metadata about the E-field result for this setting""",
        json_schema_extra={"linkml_meta": {"domain_of": ["StimulationSetting"]}},
    )
...
class DBSProtocol(ConfiguredBaseModel):
    ...
    electrodes: Optional[list[Electrode]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["DBSProtocol"]}}
    )
    settings: Optional[list[StimulationSetting]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["DBSProtocol"]}}
    )
    ...
    clinical_improvement: Optional[list[ClinicalImprovement]] = Field(
        default=None,
        description="""Observed improvement relative to baseline based on a defined score.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DBSProtocol"]}},
    )
...
class ClinicalScale(ConfiguredBaseModel):
    ...
    acronym: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["ClinicalScale", "ClinicalScore", "Observation", "Function", "FunctionCall"]}
        },
    )
    name: Optional[str] = Field(
        default=None,
        description="""Full name of the scale (e.g., Unified Parkinson’s Disease Rating Scale)""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": [
                    "BrainAtlas",
    ...
    version: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["ClinicalScale", "SimulationTool", "SoftwareRequirement", "SoftwareEnvironment"]}
        },
    )
    domain: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["ClinicalScale", "ClinicalScore", "StateVariable", "Distribution", "Parameter", "PDE"]
            }
        },
    )
    reference: Optional[str] = Field(
...
class ClinicalScore(ConfiguredBaseModel):
    ...
    scale: Optional[ClinicalScale] = Field(
        default=None,
        description="""The scale this score belongs to, if applicable""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ClinicalScore", "SimulationTool", "BidsEntities"]}},
    )
    parent_score: Optional[ClinicalScore] = Field(
        default=None,
        description="""If this score is a subscore of a broader composite""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ClinicalScore"]}},
    )
...
class ClinicalImprovement(ConfiguredBaseModel):
    ...
    score: Optional[ClinicalScore] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["ClinicalImprovement"]}}
    )
    baseline_value: Optional[float] = Field(
        default=None,
        description="""Preoperative baseline value of the score""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ClinicalImprovement"]}},
    )
    absolute_value: Optional[float] = Field(
        default=None,
    ...
    time_post_surgery: Optional[float] = Field(
        default=None,
...
class EField(ConfiguredBaseModel):
    ...
    volume_data: Optional[str] = Field(
        default=None,
        description="""Reference to raw or thresholded volume""",
        json_schema_extra={"linkml_meta": {"domain_of": ["EField"]}},
    )
    coordinate_space: Optional[str] = Field(
        default=None,
    ...
    threshold_applied: Optional[float] = Field(
        default=None,
...
class SoftwarePackage(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "schema:SoftwareApplication", "from_schema": "https://w3id.org/tvbo/software"}
    )
    ...
    homepage: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwarePackage"], "slot_uri": "schema:url"}},
    )
    license: Optional[str] = Field(
        default=None,
        ...
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["CommonCoordinateSpace", "SoftwarePackage", "SoftwareRequirement", "Provenance"],
    ...
    repository: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwarePackage"], "slot_uri": "schema:codeRepository"}},
    )
    doi: Optional[str] = Field(
        default=None,
        description="""Digital Object Identifier for the software or its reference publication.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwarePackage", "SimulationStudy"]}},
    )
    ecosystem: Optional[list[EcosystemEnum]] = Field(
        default=None,
        description="""Package ecosystem(s) through which the software is distributed.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwarePackage"]}},
    )
...
class SimulationTool(SoftwarePackage):
    ...
    application_category: Optional[str] = Field(
        default=None,
        description="""High-level category (e.g., simulation, analysis, specification).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:applicationCategory"}},
    )
    scale: Optional[list[SimulationScale]] = Field(
        default=None,
        description="""Spatial/organizational scales the tool operates at.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ClinicalScore", "SimulationTool", "BidsEntities"]}},
    )
    model_paradigm: Optional[list[ModelParadigm]] = Field(
        default=None,
        description="""Computational paradigms supported.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"]}},
    )
    tool_role: Optional[list[ToolRole]] = Field(
        default=None,
        description="""Primary function(s) in a simulation workflow.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"]}},
    )
    programming_language: Optional[list[ProgrammingLanguageEnum]] = Field(
        default=None,
        description="""Implementation languages.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:programmingLanguage"}},
    )
    runtime_platform: Optional[list[str]] = Field(
        default=None,
        description="""Execution backends or platforms (e.g., MPI, OpenMP, CUDA, JAX).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:runtimePlatform"}},
    )
    operating_system: Optional[list[str]] = Field(
        default=None,
        description="""Supported operating systems (e.g., Linux, macOS, Windows).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:operatingSystem"}},
    )
    interoperates_with: Optional[list[str]] = Field(
        default=None,
    ...
    version: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["ClinicalScale", "SimulationTool", "SoftwareRequirement", "SoftwareEnvironment"],
    ...
    date_created: Optional[date] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool", "Provenance"], "slot_uri": "schema:dateCreated"}},
    )
    date_modified: Optional[date] = Field(
        default=None,
        description="""Date of the most recent release or significant update.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:dateModified"}},
    )
    ...
    author: Optional[list[str]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["BrainAtlas", "SimulationTool"], "slot_uri": "schema:author"}},
    )
    maintainer: Optional[list[str]] = Field(
        default=None,
        description="""Current maintainer(s) or responsible organization(s).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:maintainer"}},
    )
    funder: Optional[list[str]] = Field(
        default=None,
        description="""Funding bodies or grants (e.g., 'EU H2020 945539', 'NIH R01...').""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:funder"}},
    )
    reference_publication: Optional[str] = Field(
        default=None,
    ...
    citation: Optional[list[str]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:citation"}},
    )
    keywords: Optional[list[str]] = Field(
        default=None,
        description="""Tags for topic-based discovery and clustering.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:keywords"}},
    )
    same_as: Optional[list[str]] = Field(
        default=None,
        description="""URIs that unambiguously identify this tool (Wikidata, bio.tools, RRID, SciCrunch).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool"], "slot_uri": "schema:sameAs"}},
    )
    ...
    is_accessible_for_free: Optional[bool] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["SimulationTool"], "ifabsent": "True", "slot_uri": "schema:isAccessibleForFree"}
        },
    )
    name: str = Field(
        default=...,
...
class SoftwareRequirement(ConfiguredBaseModel):
    ...
    package: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwareRequirement"]}},
    )
    ...
    role: Optional[RequirementRole] = Field(
        default=RequirementRole.runtime,
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwareRequirement"], "ifabsent": "runtime"}},
    )
    optional: Optional[bool] = Field(
        default=False, json_schema_extra={"linkml_meta": {"domain_of": ["SoftwareRequirement"], "ifabsent": "False"}}
    )
...
class SoftwareEnvironment(ConfiguredBaseModel):
    ...
    platform: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwareEnvironment"]}},
    )
    ...
    requirements: Optional[dict[str, SoftwareRequirement]] = Field(
        default=None,
        description="""Constituent software requirements.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SoftwareEnvironment", "Function", "PDESolver"]}},
    )
...
class Range(ConfiguredBaseModel):
    ...
    lo: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Range"], "ifabsent": "string(0)"}},
    )
    hi: Optional[str] = Field(
        default=None,
        description="""Upper bound or stopping value. Can be a number or argument name.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Range"]}},
    )
    ...
    log_scale: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Range"], "ifabsent": "False"}},
    )
    explored_values: Optional[AnyShapeArray[float]] = Field(
        default=None,
        description="""Explicit explored values for this element. When set on an element_domain entry, overrides the parent parameter's explored_values for this specific element.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Range", "Parameter"]}},
    )
    element: Optional[int] = Field(
        default=None,
        description="""Element/node index this range applies to. Used in element_domains to explicitly link a domain to a specific element of a heterogeneous parameter (e.g., element: 0 for node 0). Required when used in element_domains to avoid ambiguous positional indexing.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Range"]}},
    )
...
class Equation(ConfiguredBaseModel):
    ...
    definition: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Equation", "StateVariable", "Parameter", "Function", "DifferentialOperator"]}
        },
    )
...
class ConditionalBlock(ConfiguredBaseModel):
    ...
    expression: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ConditionalBlock", "DifferentialOperator"]}},
    )
...
class Stimulus(ConfiguredBaseModel):
    ...
    duration: Optional[float] = Field(
        default=1000,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Stimulus", "Event", "InitialState", "Integrator"], "ifabsent": "float(1000)"}
        },
    )
    label: Optional[str] = Field(
        default=None,
    ...
    regions: Optional[AnyShapeArray[int]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Stimulus", "Event"]}}
    )
    weighting: Optional[AnyShapeArray[float]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Stimulus", "Event"]}}
    )
...
class Event(ConfiguredBaseModel):
    ...
    event_type: Optional[EventType] = Field(
        default=EventType.stimulus,
        description="""Type of event trigger mechanism.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Event"], "ifabsent": "stimulus"}},
    )
    condition: Optional[Equation] = Field(
        default=None,
    ...
    condition_states: Optional[list[str]] = Field(
        default=None,
    ...
    condition_parameters: Optional[list[str]] = Field(
        default=None,
        description="""Parameter symbols accessible in the condition function.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Event"]}},
    )
    affect: Optional[Equation] = Field(
        default=None,
    ...
    regions: Optional[AnyShapeArray[int]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Stimulus", "Event"]}},
    )
    weighting: Optional[AnyShapeArray[float]] = Field(
        default=None,
    ...
    duration: Optional[float] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Stimulus", "Event", "InitialState", "Integrator"]}},
    )
...
class TemporalApplicableEquation(Equation):
    ...
    time_dependent: Optional[bool] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["TemporalApplicableEquation", "SpatialField", "BoundaryCondition"],
                "ifabsent": "False",
            }
        },
    )
...
class Parcellation(ConfiguredBaseModel):
    ...
    data_source: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Parcellation", "Tractogram", "Observation"]}}
    )
...
class Tractogram(ConfiguredBaseModel):
    ...
    data_source: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Parcellation", "Tractogram", "Observation"]}},
    )
    number_of_subjects: Optional[int] = Field(
        default=None,
        description="""Number of subjects in the tractography dataset""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Tractogram"]}},
    )
    acquisition: Optional[str] = Field(
        default=None,
        description="""Acquisition protocol or scanner information""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Tractogram", "BidsEntities"]}},
    )
...
class Matrix(ConfiguredBaseModel):
    ...
    x: Optional[BrainRegionSeries] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Coordinate", "Matrix"]}}
    )
    y: Optional[BrainRegionSeries] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Coordinate", "Matrix"]}}
    )
    values: Optional[list[float]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Matrix", "BrainRegionSeries", "SpatialField"]}}
    )
    format: Optional[SparseFormat] = Field(
        default=None,
        description="""Storage format in binary companion (dense, csr, coo)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Matrix", "Edge", "DataSource"]}},
    )
    shape: Optional[list[int]] = Field(
        default=None,
        description="""Matrix dimensions [N, M]""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Matrix", "Parameter", "NDArray"]}},
    )
    dtype: Optional[str] = Field(
        default="float32",
        description="""Data type for matrix values""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Matrix", "NDArray"], "ifabsent": "string(float32)"}},
    )
...
class Provenance(ConfiguredBaseModel):
    ...
    derived_from: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Provenance", "SimulationStudy"]}}
    )
    references: Optional[list[str]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Provenance", "Dynamics", "SimulationExperiment"]}}
    )
    date_created: Optional[str] = Field(
        default=None,
        description="""ISO 8601 (prov:generatedAtTime)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationTool", "Provenance"]}},
    )
    license: Optional[str] = Field(
        default=None,
        json_schema_extra={
    ...
    generated_by: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Provenance"]}},
    )
...
class BidsEntities(ConfiguredBaseModel):
    ...
    template: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["BidsEntities"]}},
    )
    ...
    reconstruction: Optional[str] = Field(
        default=None,
        description="""BIDS rec- entity (e.g., dTOR)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BidsEntities"]}},
    )
    segmentation: Optional[str] = Field(
        default=None,
    ...
    atlas: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Parcellation", "BidsEntities"]}},
    )
    acquisition: Optional[str] = Field(
        default=None,
...
class Network(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "aliases": ["Network", "Connectome", "Graph", "Connectivity"],
    ...
    nodes: Optional[list[Node]] = Field(
        default=None,
        description="""List of nodes with individual dynamics (optional, for heterogeneous networks)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    edges: Optional[list[Edge]] = Field(
        default=None,
        description="""List of directed edges with coupling references (optional, for explicit edge definition)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    coupling: Optional[dict[str, Coupling]] = Field(
        default=None,
        description="""Reusable coupling configurations referenced by edges (e.g., 'instant', 'delayed', 'inhibitory')""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network", "Edge", "SimulationExperiment"]}},
    )
    dynamics: Optional[dict[str, Dynamics]] = Field(
        default=None,
        description="""Dictionary of dynamics models keyed by name. Nodes reference these by name. For heterogeneous networks with per-node dynamics.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network", "Node", "Edge", "Continuation", "SimulationExperiment"]}},
    )
    number_of_nodes: Optional[int] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {
                "aliases": ["number_of_nodes", "number_of_regions"],
                "domain_of": ["Network"],
                "ifabsent": "integer(1)",
            }
        },
    )
    coordinate_space: Optional[CommonCoordinateSpace] = Field(
        default=None,
        description="""Coordinate space for node positions (e.g., MNI152NLin2009c). Mirrors BrainAtlas.coordinateSpace so network node positions are unambiguous.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["DBSDataset", "DBSSubject", "Electrode", "EField", "Network", "SpatialDomain", "Mesh"]
            }
    ...
    parcellation: Optional[Parcellation] = Field(
        default=None,
        description="""Brain parcellation/atlas reference""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    tractogram: Optional[Tractogram] = Field(
        default=None,
        description="""Reference to tractography data""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    transforms: Optional[list[Function]] = Field(
        default=None,
        description="""Ordered list of transforms applied to edge property matrices. Each Function's name identifies the target edge property (e.g. 'weight', 'length'). Supports equation-based (symbolic) or callable-based (software) transforms. Multiple transforms on the same target are applied sequentially.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    ...
    descriptor: Optional[str] = Field(
        default=None,
        description="""Short alphanumeric identifier for the BIDS desc- filename entity (e.g., SC, FC, EC, SCFC). Classifies the connectivity modality of the network's edge measures.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    bids_dir: Optional[str] = Field(
        default=None,
        description="""Path to BEP017-compliant BIDS directory for loading connectivity matrices""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    bids: Optional[BidsEntities] = Field(
        default=None,
        description="""BIDS filename entities for this dataset""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    structural_measures: Optional[list[str]] = Field(
        default=None,
        description="""BEP017 measure names for structural connectivity (e.g., streamlineCount, tractLength)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}},
    )
    observational_measures: Optional[list[str]] = Field(
        default=None,
    ...
    parent_network: Optional[str] = Field(
        default=None,
    ...
    node_mapping: Optional[str] = Field(
        default=None,
    ...
    distance_unit: Optional[UnitEnum] = Field(
        default=UnitEnum.mm,
        description="""Unit for distances/lengths in the network""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"], "ifabsent": "string(mm)"}},
    )
    time_unit: Optional[UnitEnum] = Field(
        default=UnitEnum.ms,
        description="""Default time unit for the network""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network"], "ifabsent": "string(ms)"}},
    )
    edge_matrix_files: Optional[list[str]] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Network"]}})
    graph_generator: Optional[GraphGenerator] = Field(
        default=None,
...
""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["GraphGenerator", "File", "Aggregation", "TuningObjective", "Algorithm"]}
        },
    )
    seed: Optional[int] = Field(
        default=None,
        description="""Random seed for reproducible graph generation.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["GraphGenerator", "Distribution", "Noise"]}},
    )
    directed: Optional[bool] = Field(
        default=False,
        description="""Whether to generate a directed graph.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["GraphGenerator", "Edge"], "ifabsent": "boolean(false)"}},
    )
    parameters: Optional[dict[str, Parameter]] = Field(
        default=None,
...
class Node(ConfiguredBaseModel):
    ...
    record: Optional[bool] = Field(
        default=True,
        description="""Whether to include this element in simulation output files. Applicable to state variables (default true), derived variables (default false), and network nodes (default true). Set false to suppress recording.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Node", "StateVariable", "DerivedVariable"], "ifabsent": "True"}},
    )
    id: int = Field(
        default=...,
        description="""Unique node identifier""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Node", "SimulationExperiment"]}},
    )
    dynamics: Optional[str] = Field(
        default=None,
        description="""Dynamics model governing this node's behavior. Can be a reference (by name) or inline definition. If not provided, uses experiment's dynamics.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network", "Node", "Edge", "Continuation", "SimulationExperiment"]}},
    )
    position: Optional[Coordinate] = Field(
        default=None,
        description="""Spatial coordinates (x, y, z) of the node""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Node"]}},
    )
    region: Optional[str] = Field(
        default=None,
        description="""Brain region or anatomical label""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Node", "SpatialDomain"]}},
    )
    state: Optional[dict[str, Union[float, StateValue]]] = Field(
        default=None,
    ...
    events: Optional[dict[str, Event]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Node", "Edge", "Dynamics", "SimulationExperiment"]}},
    )
...
class StateValue(ConfiguredBaseModel):
    ...
    value: Optional[float] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["StateValue", "Parameter", "Argument", "Option", "BoundaryCondition"]}
        },
    )
...
class Edge(ConfiguredBaseModel):
    ...
    source: Optional[int] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge", "Observation", "Dynamics", "CouplingInput"]}},
    )
    target: Optional[int] = Field(
        default=None,
        description="""Target node ID (set for explicit edges, absent for template edges)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"]}},
    )
    ...
    weighted: Optional[bool] = Field(
        default=True,
        description="""Matrix entries carry weights (not just 0/1)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"], "ifabsent": "boolean(true)"}},
    )
    valid_diagonal: Optional[bool] = Field(
        default=False,
        description="""Self-connections are meaningful""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"], "ifabsent": "boolean(false)"}},
    )
    non_negative: Optional[bool] = Field(
        default=True,
        description="""All values >= 0""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"], "ifabsent": "boolean(true)"}},
    )
    source_var: Optional[str] = Field(
        default=None,
        description="""Output variable from source node to use (e.g., 'x_out'). If not specified, uses first output variable from source dynamics.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"]}},
    )
    target_var: Optional[str] = Field(
        default=None,
        description="""Input variable on target node to connect to (e.g., 'c_in'). If not specified, uses first coupling input from target dynamics.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"]}},
    )
    coupling: Optional[str] = Field(
        default=None,
    ...
    directed: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["GraphGenerator", "Edge"], "ifabsent": "False"}},
    )
    target_network: Optional[str] = Field(
        default=None,
        description="""Path or name of the Network whose nodes define the columns of a non-square (projection) matrix. For example, a gain matrix with shape (n_sensors, n_regions) references the brain parcellation network here.  Row labels come from the parent Network's own nodes.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"]}},
    )
    dimension_labels: Optional[list[str]] = Field(
        default=None,
        description="""Ordered labels for the matrix columns (dim-1) when the matrix is non-square.  Row labels (dim-0) are the parent Network's node labels.  Stored as HDF5 dimension scales in the companion file.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge"]}},
    )
    dynamics: Optional[str] = Field(
        default=None,
...
class Observation(ConfiguredBaseModel):
    ...
    environment: Optional[SoftwareEnvironment] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Observation", "SimulationExperiment", "PDESolver"]}}
    )
    time_scale: Optional[UnitEnum] = Field(
        default=UnitEnum.ms,
        description="""Time unit for the integration / simulation. Determines the physical time meaning of one model time-step.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation", "Integrator"], "ifabsent": "ms"}},
    )
    source: Optional[str] = Field(
        default=None,
        description="""State variable to observe (e.g., S_e for excitatory activity). For observations derived from other observations, use DerivedObservation.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge", "Observation", "Dynamics", "CouplingInput"]}},
    )
    period: Optional[float] = Field(
        default=None,
        description="""Sampling period for monitors (ms). For BOLD: TR in ms.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    downsample_period: Optional[float] = Field(
        default=None,
        description="""Intermediate downsampling period (ms). For BOLD: typically matches dt.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    voi: Optional[int] = Field(
        default=None,
        description="""Variable of interest index (which state variable to monitor). Default: 0.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    imaging_modality: Optional[ImagingModality] = Field(
        default=None,
        description="""Type of imaging modality (BOLD, EEG, MEG, etc.)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    warmup_source: Optional[str] = Field(
        default=None,
        description="""Reference to transient simulation result for history initialization (e.g., 'result_init').""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation", "ClassReference"]}},
    )
    data_source: Optional[DataSource] = Field(
        default=None,
        description="""Load data from external source (file, database, API). When specified, this observation represents empirical/external data rather than simulated data. Enables unified treatment of all data.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Parcellation", "Tractogram", "Observation"]}},
    )
    skip_t: Optional[int] = Field(
        default=None,
        description="""Number of samples to skip at the start (transient removal). For FC: typically 10-20 TRs.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    tail_samples: Optional[int] = Field(
        default=None,
        description="""Number of samples from the end to use. Takes the last N samples before aggregation. E.g., tail_samples: 500 means use data[-500:].""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    aggregation: Optional[AggregationType] = Field(
        default=None,
        description="""How to aggregate over time""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation", "Coupling"]}},
    )
    ...
    pipeline: Optional[list[FunctionCall]] = Field(
        default=None,
        description="""Ordered sequence of Functions. Each Function transforms input -> output.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation"]}},
    )
    class_reference: Optional[ClassReference] = Field(
        default=None,
...
class DerivedObservation(Observation):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "tvbo:DerivedObservation", "from_schema": "https://w3id.org/tvbo"}
    )

    source_observations: list[str] = Field(
        default=...,
        description="""One or more observations to derive from. For transformations (e.g., fc from bold), use single source. For comparisons (e.g., fc_corr from fc and fc_target), use multiple sources. Order may matter for asymmetric operations.""",
        min_length=1,
        json_schema_extra={"linkml_meta": {"domain_of": ["DerivedObservation"]}},
    )
    name: str = Field(
        default=...,
        json_schema_extra={
...
class Dynamics(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "aliases": ["NeuralMassModel"],
            "class_uri": "tvbo:Dynamics",
            "comments": ["Successor class replacing deprecated NeuralMassModel."],
            "from_schema": "https://w3id.org/tvbo",
            "slot_usage": {
                "name": {"ifabsent": "Generic2dOscillator", "name": "name"},
                "system_type": {"ifabsent": "continuous", "name": "system_type"},
            },
        }
    )
    ...
    iri: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "Function", "Coupling"]}}
    )
    parameters: Optional[dict[str, Parameter]] = Field(
        default=None,
        json_schema_extra={
    ...
    source: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Edge", "Observation", "Dynamics", "CouplingInput"]}}
    )
    references: Optional[list[str]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Provenance", "Dynamics", "SimulationExperiment"]}}
    )
    derived_parameters: Optional[dict[str, DerivedParameter]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "PDE"]}}
    )
    derived_variables: Optional[dict[str, DerivedVariable]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "PDE"]}}
    )
    coupling_terms: Optional[dict[str, Parameter]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}}
    )
    coupling_inputs: Optional[dict[str, CouplingInput]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}}
    )
    state_variables: Optional[dict[str, StateVariable]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "PDE"]}}
    )
    modified: Optional[bool] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}})
    output: Optional[list[str]] = Field(
        default=None,
        description="""Output variable names to include in simulation results. References to state_variables or derived_variables by name.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "Function", "FunctionCall"]}},
    )
    derived_from_model: Optional[str] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}})
    number_of_modes: Optional[int] = Field(
        default=1, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"], "ifabsent": "integer(1)"}}
    )
    local_coupling_term: Optional[str] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}})
    functions: Optional[dict[str, Function]] = Field(
        default=None,
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "Algorithm", "SimulationExperiment", "PDE"]}},
    )
    stimulus: Optional[Stimulus] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}})
    modes: Optional[dict[str, Dynamics]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"aliases": ["components"], "domain_of": ["Dynamics"]}}
    )
    model_type: Optional[ModelType] = Field(
        default=None,
        description="""Coarse classification of this model (mean_field, neural_mass, phase_oscillator, phenomenological, spiking, generic, field). Used for filtering in Dynamics.list_db(model_type=...).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"]}},
    )
    system_type: Optional[SystemType] = Field(
        default=SystemType.continuous, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"], "ifabsent": "continuous"}}
    )
    autonomous: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics"], "ifabsent": "true"}},
    )
    observed: Optional[dict[str, DerivedVariable]] = Field(
        default=None,
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "Coupling"]}},
    )
    events: Optional[dict[str, Event]] = Field(
        default=None,
        description="""Discrete state transitions intrinsic to the dynamical system, such as threshold-triggered resets in spiking neuron models. Unlike experiment-level events (stimulation, perturbation), these define the model's own discontinuous behavior.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Node", "Edge", "Dynamics", "SimulationExperiment"]}},
    )
...
class StateVariable(ConfiguredBaseModel):
    ...
    symbol: Optional[str] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["StateVariable", "Parameter", "DerivedParameter", "DerivedVariable"]}
        },
    )
    label: Optional[str] = Field(
        default=None,
    ...
    variable_of_interest: Optional[bool] = Field(
        default=True, json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable"], "ifabsent": "True"}}
    )
    coupling_variable: Optional[bool] = Field(
        default=False,
        description="""Whether this state variable is transmitted to connected nodes through the coupling function. In TVB terms, this determines the cvar indices (state variables extracted from history and fed into the coupling function). The coupling function may override this via its incoming_states attribute.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable"], "ifabsent": "False"}},
    )
    equation_type: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable"], "ifabsent": "string(differential)"}},
    )
    equation_order: Optional[int] = Field(
        default=1,
        description="""Order of the time derivative on the LHS. Default 1 means dx/dt = rhs (first-order ODE). Order 2 means d²x/dt² = rhs (second-order ODE), etc. Higher-order ODEs are automatically lowered to coupled first-order systems by backends like ModelingToolkit.jl via mtkcompile.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable"], "ifabsent": "int(1)"}},
    )
    noise: Optional[Noise] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable", "Integrator"]}}
    )
    stimulation_variable: Optional[bool] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable"]}}
    )
    ...
    initial_value: Optional[float] = Field(
        default=0.1,
        json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable", "SpatialField"], "ifabsent": "float(0.1)"}},
    )
    derivative_initial_value: Optional[float] = Field(
        default=None,
        description="""Initial value for the first time derivative, used when equation_order > 1. For a second-order ODE d²x/dt² = f, this sets dx/dt(0). Required by ModelingToolkit.jl to fully specify higher-order initial value problems.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable"]}},
    )
    distribution: Optional[Distribution] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["StateVariable", "Parameter", "Coupling"]}},
    )
...
class Distribution(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://w3id.org/tvbo", "slot_usage": {"name": {"ifabsent": "string(Uniform)", "name": "name"}}}
    )
    ...
    function: Optional[Function] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Distribution", "FunctionCall", "Noise"]}},
    )
    seed: Optional[int] = Field(
        default=None,
    ...
    axis: Optional[SamplingAxis] = Field(
        default=SamplingAxis.space,
        description="""Dimension along which the distribution is sampled. 'space' = per-node (default), 'time' = per-timestep (stochastic input).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Distribution"], "ifabsent": "space"}},
    )
...
class Parameter(ConfiguredBaseModel):
    ...
    dataset_path: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Parameter"]}},
    )
    ...
    shape: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Matrix", "Parameter", "NDArray"]}}
    )
    explored_values: Optional[AnyShapeArray[float]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Range", "Parameter"]}}
    )
    element_domains: Optional[list[Range]] = Field(
        default=None,
        description="""Per-element domain overrides for heterogeneous parameters. When specified, element_domains[i] overrides domain for element i during exploration auto-expansion. Length must match parameter shape (e.g., n_nodes for shape \"(n_nodes,)\"). If not set, all elements share the same domain.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Parameter"]}},
    )
...
class CouplingInput(ConfiguredBaseModel):
    ...
    source: Optional[str] = Field(
        default=None,
        description="""Name of the coupling function that feeds this input. When omitted, resolved automatically: (1) same name as a coupling function → direct match, (2) single coupling input and single coupling function → auto-mapped, (3) multiple of each → positional order.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Edge", "Observation", "Dynamics", "CouplingInput"]}},
    )
    dimension: Optional[int] = Field(
        default=1,
        description="""Dimensionality of the coupling input (number of coupled values)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["CouplingInput"], "ifabsent": "integer(1)"}},
    )
    keys: Optional[list[str]] = Field(
        default=None,
        description="""Named keys for multi-dimensional coupling. When dimension > 1, provides symbolic names for each index (e.g., keys: [lre, ffi] for dimension: 2). Used in equations as variable names.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["CouplingInput"]}},
    )
...
class Argument(ConfiguredBaseModel):
    ...
    value: Optional[Union[float, int, str]] = Field(
        default=None,
        description="""Argument value. Can be: - Literal: 1.0, \"string\", etc. - Input reference: \"input.frequencies\" (from source_observation outputs) - Cross-observation: \"target_frequencies.peak_freqs\" (from another observation)""",
        json_schema_extra={
            "linkml_meta": {
                "any_of": [{"range": "float"}, {"range": "integer"}, {"range": "string"}],
                "domain_of": ["StateValue", "Parameter", "Argument", "Option", "BoundaryCondition"],
            }
        },
    )
    unit: Optional[str] = Field(
...
class Function(ConfiguredBaseModel):
    ...
    requirements: Optional[list[str]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SoftwareEnvironment", "Function", "PDESolver"]}}
    )
    input: Optional[str] = Field(
        default=None,
        description="""Simple input reference: name of previous function's output in pipeline. For multi-argument functions, use arguments with value references instead.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall"]}},
    )
    ...
    arguments: Optional[list[Argument]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall", "AlgorithmInclude"]}},
    )
    output_equation: Optional[Equation] = Field(
        default=None,
        description="""Output transformation equation (if equation-based)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function"]}},
    )
    source_code: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall"]}}
    )
    callable: Optional[Callable] = Field(
        default=None,
        description="""Software implementation reference (if software-based)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall"]}},
    )
    apply_on_dimension: Optional[DimensionType] = Field(
        default=None,
        description="""Which dimension to apply the transformation on""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall"]}},
    )
    aggregate: Optional[Aggregation] = Field(
        default=None,
        description="""How to aggregate the result across dimensions. E.g., aggregate.over=node computes per-row (per-node) with keepdims. The type field controls whether to reduce (mean/sum) or keep dimensions (none).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "LossFunction", "FunctionCall"]}},
    )
    time_range: Optional[Range] = Field(
        default=None,
        description="""Time range for generated TimeSeries (for kernel generators). Equation is evaluated at each time point.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall"]}},
    )
...
class Aggregation(ConfiguredBaseModel):
    ...
    over: Optional[DimensionType] = Field(
        default=None,
        description="""Dimension to aggregate over (e.g., node, time, state)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Aggregation"]}},
    )
    type: Optional[ReductionType] = Field(
        default=ReductionType.mean,
        description="""Aggregation operation (mean, sum, max, min, none)""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["GraphGenerator", "File", "Aggregation", "TuningObjective", "Algorithm"],
...
class LossFunction(Function):
    ...
    aggregate: Optional[Aggregation] = Field(
        default=None,
        description="""How to aggregate the loss across dimensions. Example: aggregate.over=node, aggregate.type=mean computes loss per node, then averages.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "LossFunction", "FunctionCall"]}},
    )
    name: str = Field(
        default=...,
...
class FunctionCall(ConfiguredBaseModel):
    ...
    class_call: Optional[ClassReference] = Field(
        default=None,
        description="""Class instantiation and call (alternative to callable/function). Use for external library classes that need __init__ then __call__. Example: Bold monitor from tvboptim.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["FunctionCall"]}},
    )
    input: Optional[str] = Field(
        default=None,
    ...
    apply_on_dimension: Optional[DimensionType] = Field(
        default=None,
        description="""Dimension to apply function over (generates vmap in code). E.g., 'node' applies per-node.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall"]}},
    )
    aggregate: Optional[Aggregation] = Field(
        default=None,
        description="""How to aggregate the result across dimensions. Example: aggregate.over=node, aggregate.type=mean applies function per node, then averages. Used in loss functions.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "LossFunction", "FunctionCall"]}},
    )
    arguments: Optional[list[Argument]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall", "AlgorithmInclude"]}}
    )
    time_range: Optional[Range] = Field(
        default=None,
...
class Callable(ConfiguredBaseModel):
    ...
    software: Optional[SoftwareRequirement] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Callable", "Continuation", "SimulationExperiment"]}}
    )
...
class ClassReference(Callable):
    ...
    constructor_args: Optional[list[Argument]] = Field(
        default=None,
        description="""Arguments passed to __init__ when instantiating the class. Example: period=1000.0, downsample_period=4.0 for Bold monitor.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ClassReference"]}},
    )
    call_args: Optional[list[Argument]] = Field(
        default=None,
        description="""Arguments passed when calling the instance (__call__). Usually the input data from simulation result. Example: result (simulation output array).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ClassReference"]}},
    )
    warmup_source: Optional[str] = Field(
        default=None,
        description="""Reference to transient simulation result for history initialization. Some monitors (e.g., Bold) require history from warmup simulation. Value should reference a simulation result name (e.g., 'result_init').""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation", "ClassReference"]}},
    )
    name: str = Field(
        default=...,
...
class Case(ConfiguredBaseModel):
    ...
    condition: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Session", "ConditionalBlock", "Event", "Case"]}}
    )
    equation: Optional[Equation] = Field(
        default=None,
        json_schema_extra={
...
class DerivedParameter(Parameter):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "tvbo:DerivedParameter", "from_schema": "https://w3id.org/tvbo"}
    )
...
class DerivedVariable(ConfiguredBaseModel):
    ...
    record: Optional[bool] = Field(
        default=False,
        description="""Whether to include this element in simulation output files. Applicable to state variables (default true), derived variables (default false), and network nodes (default true). Set false to suppress recording.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Node", "StateVariable", "DerivedVariable"], "ifabsent": "False"}},
    )
    conditional: Optional[bool] = Field(
        default=False, json_schema_extra={"linkml_meta": {"domain_of": ["DerivedVariable"], "ifabsent": "False"}}
    )
...
class Noise(ConfiguredBaseModel):
    ...
    noise_type: Optional[str] = Field(
        default="gaussian", json_schema_extra={"linkml_meta": {"domain_of": ["Noise"], "ifabsent": "gaussian"}}
    )
    correlated: Optional[bool] = Field(
        default=False, json_schema_extra={"linkml_meta": {"domain_of": ["Noise"], "ifabsent": "False"}}
    )
    gaussian: Optional[bool] = Field(
        default=False,
        description="""Indicates whether the noise is Gaussian""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Noise"], "ifabsent": "False"}},
    )
    additive: Optional[bool] = Field(
        default=True,
        description="""Indicates whether the noise is additive""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Noise"], "ifabsent": "True"}},
    )
    seed: Optional[int] = Field(
        default=42,
        json_schema_extra={
            "linkml_meta": {"domain_of": ["GraphGenerator", "Distribution", "Noise"], "ifabsent": "integer(42)"}
        },
    )
    random_state: Optional[RandomStream] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Noise"]}})
    intensity: Optional[Parameter] = Field(
        default=None,
        description="""Optional scalar or vector intensity parameter for noise.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Noise"]}},
    )
    function: Optional[Function] = Field(
        default=None,
    ...
    targets: Optional[dict[str, StateVariable]] = Field(
        default=None,
...
class DataSource(ConfiguredBaseModel):
    ...
    path: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["File", "DataSource"]}},
    )
    loader: Optional[Callable] = Field(
        default=None,
        description="""Callable that loads the data (e.g., load_functional_connectivity)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSource"]}},
    )
    ...
    key: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["DataSource", "SimulationStudy"]}},
    )
    preprocessing: Optional[Function] = Field(
        default=None,
...
class OptimizationStage(ConfiguredBaseModel):
    ...
    free_parameters: Optional[list[str]] = Field(
        default=None,
        description="""Parameters to optimize in this stage. Use 'shape' attribute to specify scalar vs regional. Example: {name: w, shape: \"(n_nodes,)\"} for heterogeneous.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage", "Continuation"]}},
    )
    algorithm: Optional[str] = Field(
        default="adam",
        description="""Optimizer for this stage: 'adam', 'adamw', 'sgd', etc.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["OptimizationStage", "AlgorithmInclude", "Continuation"], "ifabsent": "string(adam)"}
        },
    )
    learning_rate: Optional[float] = Field(
        default=0.001,
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage", "Algorithm"], "ifabsent": "float(0.001)"}},
    )
    max_iterations: Optional[int] = Field(
        default=100, json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage"], "ifabsent": "integer(100)"}}
    )
    hyperparameters: Optional[list[Parameter]] = Field(
        default=None,
        description="""Stage-specific hyperparameters (e.g., b2=0.9999 for adam)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage", "Algorithm"]}},
    )
    freeze_parameters: Optional[list[str]] = Field(
        default=None,
        description="""Parameters from previous stages to freeze (keep at optimized value but not update)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage"]}},
    )
    warmup_from: Optional[str] = Field(
        default=None,
        description="""Previous stage to initialize from. Final values from that stage become initial values for this stage.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage"]}},
    )
...
class Optimization(OptimizationStage):
    ...
    execution: Optional[ExecutionConfig] = Field(
        default=None,
        description="""Per-optimization execution configuration (overrides experiment-level defaults). Useful for setting random_seed, precision, or hardware for optimization phase.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Optimization", "Exploration", "Algorithm", "Continuation", "SimulationExperiment"]}
        },
    )
    integration: Optional[Integrator] = Field(
        default=None,
        description="""Integration settings for optimization simulations (overrides experiment defaults). If specified, creates a fresh model_fn and state with prepare() before optimization. Can specify different duration, step_size, method than the experiment. If not specified, uses experiment-level integration settings.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Optimization", "SimulationExperiment"]}},
    )
    loss: Optional[FunctionCall] = Field(
        default=None,
        description="""Loss function call. Uses FunctionCall to either: 1. Reference existing function: function: rmse 2. Inline callable: callable: {module: ..., name: ...} Arguments specify inputs (simulated_fc, empirical_fc, etc.)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Optimization"]}},
    )
    stages: Optional[list[OptimizationStage]] = Field(
        default=None,
        description="""Ordered list of optimization stages. Stages run sequentially. Stage n+1 starts from optimized values of stage n. When defined, inherited single-stage fields are ignored.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Optimization"]}},
    )
    depends_on: Optional[str] = Field(
        default=None,
        description="""Algorithm to use as starting point for optimization. If specified, optimization starts from algorithm's result state. If not specified, optimization starts from initial simulation state.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Optimization", "Algorithm"]}},
    )
    name: str = Field(
        default=...,
        json_schema_extra={
...
class Exploration(ConfiguredBaseModel):
    ...
    execution: Optional[ExecutionConfig] = Field(
        default=None,
        description="""Per-exploration execution configuration (overrides experiment-level defaults). Useful for setting random_seed, n_workers for parallel grid search.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Optimization", "Exploration", "Algorithm", "Continuation", "SimulationExperiment"]}
        },
    )
    parameters: Optional[dict[str, Parameter]] = Field(
        default=None,
        description="""Parameters with domain ranges to explore (uses domain.lo, domain.hi, domain.n)""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": [
                    "Equation",
    ...
    mode: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["StimulationSetting", "Exploration"], "ifabsent": "string(product)"}},
    )
    observable: Optional[FunctionCall] = Field(
        default=None,
        description="""Observable to compute at each point. Use function: obs_name for simple observation, or function: func_name + arguments for FunctionCall.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Exploration"]}},
    )
    n_parallel: Optional[int] = Field(
        default=1,
        description="""Parallel evaluations""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Exploration"], "ifabsent": "integer(1)"}},
    )
    n_trials: Optional[int] = Field(
        default=1,
        description="""Number of independent trials per grid point. Each trial uses a different noise seed. Used for averaging stochastic simulations (e.g., VEP = average of 20 trials).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Exploration"], "ifabsent": "integer(1)"}},
    )
    average: Optional[str] = Field(
        default=None,
        description="""Averaging mode across trials. 'trials' = average over n_trials independent runs (evoked potential paradigm). None = return all trials.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Exploration"]}},
    )
...
class UpdateRule(ConfiguredBaseModel):
    ...
    target_parameter: Parameter = Field(
        default=...,
        description="""The parameter to update (e.g., J_i, wLRE)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["UpdateRule"]}},
    )
    equation: Equation = Field(
        default=...,
        description="""Update equation (e.g., 'J_i + eta * delta'). Can use functions defined in experiment.functions section.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": [
                    "Stimulus",
    ...
    warmup: Optional[bool] = Field(
        default=None,
        description="""Whether to apply learning rate warmup to this update rule. When true, the learning rate (eta) is scaled by (i+1)/n_iterations.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["UpdateRule"]}},
    )
...
class AlgorithmInclude(ConfiguredBaseModel):
    ...
    algorithm: str = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage", "AlgorithmInclude", "Continuation"]}},
    )
    arguments: Optional[dict[str, Parameter]] = Field(
        default=None,
        description="""Override hyperparameter values for the included algorithm. Maps parameter names to new values.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Function", "FunctionCall", "AlgorithmInclude"]}},
    )
...
class TuningObjective(ConfiguredBaseModel):
    ...
    target_variable: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["TuningObjective"]}},
    )
    ...
    metric: Optional[Equation] = Field(
        default=None,
...
class Algorithm(ConfiguredBaseModel):
    ...
    execution: Optional[ExecutionConfig] = Field(
        default=None,
        description="""Per-algorithm execution configuration (overrides experiment-level defaults). Useful for setting random_seed per algorithm to ensure reproducibility.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Optimization", "Exploration", "Algorithm", "Continuation", "SimulationExperiment"]}
        },
    )
    ...
    includes: Optional[list[AlgorithmInclude]] = Field(
        default=None,
        description="""Include update rules from other algorithms with optional argument overrides. Unlike depends_on (sequential), includes means combined execution. Example: includes: [{algorithm: fic, arguments: [{name: eta, value: 0.1}]}]""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm"]}},
    )
    objective: Optional[TuningObjective] = Field(
        default=None,
    ...
    observations: Optional[list[str]] = Field(
        default=None,
        description="""References to observations defined in the observations section. Includes both simulated observations and external data (via data_source).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm", "SimulationExperiment"]}},
    )
    update_rules: Optional[dict[str, UpdateRule]] = Field(
        default=None,
        description="""How parameters are updated each iteration. When using 'includes', update_rules are inherited from included algorithms.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm"]}},
    )
    hyperparameters: Optional[dict[str, Parameter]] = Field(
        default=None,
    ...
    learning_rate_warmup: Optional[bool] = Field(
        default=False,
        description="""Linear warmup of learning rate from 0 to learning_rate over n_iterations. eta_effective = eta * (i+1) / n_iterations""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm"], "ifabsent": "boolean(false)"}},
    )
    ...
    simulation_period: Optional[float] = Field(
        default=None,
        description="""Duration of each simulation step (e.g., one BOLD TR)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm"]}},
    )
    apply_every: Optional[int] = Field(
        default=1,
        description="""Apply update every N iterations""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm"], "ifabsent": "integer(1)"}},
    )
    functions: Optional[list[FunctionCall]] = Field(
        default=None,
        description="""Function calls for tracking progress, computing metrics, etc. Each FunctionCall references a function from the experiment's functions section and specifies arguments for that specific algorithm context.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "Algorithm", "SimulationExperiment", "PDE"]}},
    )
...
class Discretization(ConfiguredBaseModel):
    ...
    method: Optional[NumericalDiscretizationMethod] = Field(
        default=NumericalDiscretizationMethod.collocation,
        description="""Discretization method.""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["Discretization", "InitialState", "Solver", "Integrator"],
                "ifabsent": "string(collocation)",
            }
        },
    )
    ode_solver: Optional[Solver] = Field(
        default=None,
        description="""ODE solver for flow-based methods (shooting, poincaré). Specifies algorithm (e.g. Vern9, Rodas5) and tolerances. Not needed for collocation or trapezoid.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Discretization"]}},
    )
    linear_solver: Optional[Solver] = Field(
        default=None,
        description="""Linear solver for the Newton bordered system. E.g. COPBLS (collocation), MatrixBLS (shooting/poincaré).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Discretization"]}},
    )
    mesh_intervals: Optional[int] = Field(
        default=50,
        description="""Number of mesh intervals (time slices) for collocation or trapezoid methods. Collocation: N in PeriodicOrbitOCollProblem(N, m). Trapezoid: M in PeriodicOrbitTrapProblem(M=...).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Discretization"], "ifabsent": "int(50)"}},
    )
    degree: Optional[int] = Field(
        default=4,
        description="""Polynomial degree per mesh interval for collocation. The m in PeriodicOrbitOCollProblem(N, m).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Discretization"], "ifabsent": "int(4)"}},
    )
    n_sections: Optional[int] = Field(
        default=3,
        description="""Number of shooting sections for shooting or Poincaré methods.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Discretization"], "ifabsent": "int(3)"}},
    )
    options: Optional[dict[str, Union[str, Option]]] = Field(
        default=None,
        description="""Toolkit-specific string options (jacobian type, etc.).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Discretization", "BranchSwitch", "Continuation"]}},
    )
...
class InitialState(ConfiguredBaseModel):
    ...
    method: Optional[InitialStateMethod] = Field(
        default=InitialStateMethod.time_integration,
    ...
    duration: Optional[float] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Stimulus", "Event", "InitialState", "Integrator"], "ifabsent": "float(2000.0)"}
        },
    )
    abs_tol: Optional[float] = Field(
        default=1e-10,
        description="""Absolute tolerance for ODE integration.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["InitialState", "Solver"], "ifabsent": "float(1e-10)"}},
    )
    rel_tol: Optional[float] = Field(
        default=1e-10,
    ...
    solver: Optional[Solver] = Field(
        default=None,
        description="""ODE solver for time_integration method. Specify method (e.g., Tsit5, Heun, RK4) and tolerances.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["InitialState", "PDE"]}},
    )
    source_branch: Optional[str] = Field(
        default=None,
        description="""Name of a previously computed branch (for from_branch method).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["InitialState"]}},
    )
    source_point: Optional[str] = Field(
        default=None,
        description="""Which point on the source branch: 'endpoint', 'hopf:1', 'fold:2', a step number, etc.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["InitialState", "BranchSwitch"]}},
    )
...
class BranchSwitch(ConfiguredBaseModel):
    ...
    source_point: Optional[str] = Field(
        default=None,
        description="""Which bifurcation point to start from. Syntax: - 'hopf:-1' = last Hopf (default) - 'hopf:all' = all Hopf points - 'hopf:1' = first Hopf - 'fold:2' = second fold - integer = specific special point index""",
        json_schema_extra={"linkml_meta": {"domain_of": ["InitialState", "BranchSwitch"]}},
    )
    delta_p: Optional[float] = Field(
        default=None,
        description="""Initial parameter offset from the bifurcation point.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BranchSwitch"]}},
    )
    continuation: Optional[Continuation] = Field(
        default=None,
        description="""Override solver settings for this branch. Uses the same Continuation type — only explicitly set attributes override the parent's values.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BranchSwitch"]}},
    )
    discretization: Optional[Discretization] = Field(
        default=None,
        description="""Discretization method for the branch solution. Required for periodic orbit branches (Hopf → PO). Not needed for codim-2 branches (fold/Hopf continuation).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BranchSwitch", "PDESolver"]}},
    )
    bothside: Optional[bool] = Field(
        default=None,
        description="""Continue branch in both directions.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BranchSwitch", "Continuation"]}},
    )
    options: Optional[dict[str, Union[str, Option]]] = Field(
        default=None,
...
class Continuation(ConfiguredBaseModel):
    ...
    dynamics: Optional[str] = Field(
        default=None,
        description="""Reference to the dynamical system model (by name). Resolved from the experiment's dynamics dict at runtime.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network", "Node", "Edge", "Continuation", "SimulationExperiment"]}},
    )
    free_parameters: Optional[dict[str, Parameter]] = Field(
        default=None,
        description="""Parameters to vary. First parameter is primary (codim-1); second enables codim-2 continuation. Each Parameter has name + domain (Range with lo/hi bounds).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["OptimizationStage", "Continuation"]}},
    )
    ds: Optional[float] = Field(
        default=None,
        description="""Initial arc-length step size.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    ds_min: Optional[float] = Field(
        default=None,
        description="""Minimum adaptive step size.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    ds_max: Optional[float] = Field(
        default=None,
    ...
    newton_tol: Optional[float] = Field(
        default=None,
        description="""Absolute tolerance for Newton corrector convergence.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    newton_max_iterations: Optional[int] = Field(
        default=None,
        description="""Maximum Newton corrector iterations per step.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    nev: Optional[int] = Field(
        default=None,
        description="""Number of eigenvalues to compute. Must be >= number of state variables for reliable Hopf detection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    tol_stability: Optional[float] = Field(
        default=None,
        description="""Tolerance on real part of eigenvalue for stability boundary.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    detect_bifurcation: Optional[int] = Field(
        default=None,
        description="""Bifurcation detection level. 0 = off, 1 = eigenvalues only, 2 = detect, 3 = locate precisely.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    detect_fold: Optional[bool] = Field(
        default=None,
        description="""Enable fold (limit point) detection.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    n_inversion: Optional[int] = Field(
        default=None,
        description="""Number of eigenvalue sign inversions to flag a bifurcation. Must be even. Higher = fewer false positives.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    max_bisection_steps: Optional[int] = Field(
        default=None,
        description="""Maximum bisection steps for bifurcation point localization.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    algorithm: Optional[ContinuationAlgorithm] = Field(
        default=ContinuationAlgorithm.PALC,
        description="""Predictor-corrector algorithm.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["OptimizationStage", "AlgorithmInclude", "Continuation"], "ifabsent": "string(PALC)"}
        },
    )
    initial_state: Optional[InitialState] = Field(
        default=None,
        description="""How to obtain the initial equilibrium. Default: time integration to steady state.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    branches: Optional[dict[str, BranchSwitch]] = Field(
        default=None,
        description="""Child branches to continue from detected bifurcation points (PO from Hopf, fold continuation, etc.).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Continuation"]}},
    )
    bothside: Optional[bool] = Field(
        default=None,
    ...
    software: Optional[SoftwareRequirement] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Callable", "Continuation", "SimulationExperiment"]}},
    )
    options: Optional[dict[str, Union[str, Option]]] = Field(
        default=None,
...
class Integrator(Solver):
    ...
    step_size: Optional[float] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"aliases": ["dt"], "domain_of": ["Integrator"], "ifabsent": "float(0.01220703125)"}
        },
    )
    ...
    state_wise_sigma: Optional[list[float]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator"]}}
    )
    transient_time: Optional[float] = Field(
        default=0, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator"], "ifabsent": "float(0)"}}
    )
    scipy_ode_base: Optional[bool] = Field(
        default=False, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator"], "ifabsent": "False"}}
    )
    number_of_stages: Optional[int] = Field(
        default=1, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator"], "ifabsent": "integer(1)"}}
    )
    intermediate_expressions: Optional[dict[str, DerivedVariable]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator"]}}
    )
    update_expression: Optional[DerivedVariable] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator"]}}
    )
    delayed: Optional[bool] = Field(
        default=True, json_schema_extra={"linkml_meta": {"domain_of": ["Integrator", "Coupling"], "ifabsent": "True"}}
    )
    abs_tol: Optional[float] = Field(
        default=1e-10,
        description="""Absolute tolerance for adaptive solvers.""",
...
class Coupling(ConfiguredBaseModel):
    ...
    delayed: Optional[bool] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Integrator", "Coupling"], "ifabsent": "True"}},
    )
    symmetry: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Coupling"], "ifabsent": "string(directed)"}},
    )
    outsym: Optional[list[str]] = Field(
        default=None,
    ...
    aggregation: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"any_of": [{"range": "string"}, {"range": "Function"}], "domain_of": ["Observation", "Coupling"]}
        },
    )
...
class ExecutionConfig(ConfiguredBaseModel):
    ...
    n_workers: Optional[int] = Field(
        default=1,
        description="""Number of parallel workers (maps to pmap devices in JAX, processes in multiprocessing)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExecutionConfig"], "ifabsent": "integer(1)"}},
    )
    ...
    precision: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ExecutionConfig"], "ifabsent": "string(float64)"}},
    )
    accelerator: Optional[str] = Field(
        default="cpu",
        description="""Hardware accelerator: 'cpu', 'gpu', 'tpu'""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExecutionConfig"], "ifabsent": "string(cpu)"}},
    )
    batch_size: Optional[int] = Field(
        default=None,
        description="""Batch size for vectorized operations (None = auto)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExecutionConfig"]}},
    )
    random_seed: Optional[int] = Field(
        default=42,
        description="""Base random seed for reproducibility""",
        json_schema_extra={"linkml_meta": {"domain_of": ["ExecutionConfig"], "ifabsent": "integer(42)"}},
    )
    find_fixpoint: Optional[bool] = Field(
        default=False,
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["ExecutionConfig"], "ifabsent": "False"}},
    )


class SimulationExperiment(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "tvbo:Simulation", "from_schema": "https://w3id.org/tvbo", "tree_root": True}
    )
    ...
    additional_equations: Optional[list[Equation]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}}
    )
    label: Optional[str] = Field(
        default=None,
        json_schema_extra={
    ...
    dynamics: Optional[Dynamics] = Field(
        default=None,
        description="""Default dynamics model for all nodes. For heterogeneous networks with multiple dynamics, use network.dynamics instead.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Network", "Node", "Edge", "Continuation", "SimulationExperiment"]}},
    )
    integration: Optional[Integrator] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Optimization", "SimulationExperiment"]}}
    )
    connectivity: Optional[Network] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "deprecated": "Use 'network' instead. 'connectivity' is kept for backward "
    ...
    network: Optional[Network] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Subject", "Session", "SimulationExperiment"]}}
    )
    coupling: Optional[Coupling] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Network", "Edge", "SimulationExperiment"]}}
    )
    observations: Optional[dict[str, Observation]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Algorithm", "SimulationExperiment"]}}
    )
    derived_observations: Optional[dict[str, DerivedObservation]] = Field(
        default=None,
        description="""Observations derived from combining other observations. Computed after all regular observations are available. Examples: fc_corr (from fc, fc_target), rmse, etc.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}},
    )
    functions: Optional[dict[str, Function]] = Field(
        default=None,
        description="""Reusable function definitions. Referenced by name in observation pipelines. Enables DRY: define compute_fc once, use in both simulated and empirical paths.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "Algorithm", "SimulationExperiment", "PDE"]}},
    )
    stimulation: Optional[Stimulus] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}}
    )
    events: Optional[dict[str, Event]] = Field(
        default=None,
    ...
    field_dynamics: Optional[PDE] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}}
    )
    optimizations: Optional[dict[str, Optimization]] = Field(
        default=None,
        description="""Parameter optimization configurations""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}},
    )
    explorations: Optional[dict[str, Exploration]] = Field(
        default=None,
        description="""Parameter exploration/grid search specifications""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}},
    )
    algorithms: Optional[dict[str, Algorithm]] = Field(
        default=None,
        description="""Iterative parameter tuning algorithms (FIC, EIB, etc.)""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}},
    )
    continuations: Optional[dict[str, Continuation]] = Field(
        default=None,
        description="""Numerical continuation and bifurcation analysis specifications. Each entry defines a continuation experiment (equilibrium branch, codim-2 curve, periodic orbit family, etc.).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}},
    )
    environment: Optional[SoftwareEnvironment] = Field(
        default=None,
        description="""Execution environment (collection of requirements).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Observation", "SimulationExperiment", "PDESolver"]}},
    )
    execution: Optional[ExecutionConfig] = Field(
        default=None,
    ...
    dataset: Optional[Dataset] = Field(
        default=None,
        description="""Multi-subject dataset for workflow rendering. When set, render_workflow() uses dataset.subjects/sessions to generate per-subject parallel jobs.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SimulationExperiment"]}},
    )
...
class SimulationStudy(ConfiguredBaseModel):
    ...
    key: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["DataSource", "SimulationStudy"]}}
    )
    ...
    doi: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SoftwarePackage", "SimulationStudy"]}}
    )
    sample: Optional[Sample] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SimulationStudy"]}})
    experiments: Optional[list[SimulationExperiment]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SimulationStudy"]}}
    )
...
class TimeSeries(ConfiguredBaseModel):
    ...
    sampling_rate: Optional[float] = Field(
        default=None, description="""Sampling rate in Hz.""", json_schema_extra={"linkml_meta": {"domain_of": ["TimeSeries"]}}
    )
    sampling_period: Optional[float] = Field(
        default=None,
        description="""Time between samples (inverse of sampling_rate).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["TimeSeries"]}},
    )
    sampling_period_unit: Optional[str] = Field(
        default="ms",
        description="""Unit of the sampling period (e.g., 'ms', 's').""",
        json_schema_extra={"linkml_meta": {"domain_of": ["TimeSeries"], "ifabsent": "ms"}},
    )
    unit: Optional[str] = Field(
        default=None,
    ...
    software_environment: Optional[SoftwareEnvironment] = Field(
        default=None,
    ...
    subject_id: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Subject", "TimeSeries"]}},
    )
    ...
    run_id: Optional[int] = Field(
        default=None, description="""BIDS run number.""", json_schema_extra={"linkml_meta": {"domain_of": ["TimeSeries"]}}
    )
...
class SpatialDomain(ConfiguredBaseModel):
    ...
    geometry: Optional[str] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SpatialDomain"]}},
    )
...
class Mesh(ConfiguredBaseModel):
    ...
    coordinates: Optional[list[Coordinate]] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["Mesh"]}},
    )
    ...
    mesh_format: Optional[str] = Field(
        default=None,
        description="""Explicit format override (gifti, freesurfer, meshio, vtk, gmsh). Auto-detected from extension if null.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["Mesh"]}},
    )
    number_of_vertices: Optional[int] = Field(
        default=None,
...
class SpatialField(ConfiguredBaseModel):
    ...
    quantity_kind: Optional[str] = Field(
        default=None,
        description="""Scalar, vector, or tensor.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["SpatialField"]}},
    )
    unit: Optional[str] = Field(
        default=None,
        json_schema_extra={
    ...
    mesh: Optional[Mesh] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["SpatialField", "FieldStateVariable", "PDE"]}}
    )
    values: Optional[NDArray] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Matrix", "BrainRegionSeries", "SpatialField"]}}
    )
    time_dependent: Optional[bool] = Field(
        default=False,
    ...
    initial_expression: Optional[Equation] = Field(
        default=None,
...
class FieldStateVariable(StateVariable):
    ...
    boundary_conditions: Optional[list[BoundaryCondition]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["FieldStateVariable", "PDE"]}}
    )
    name: str = Field(
        default=...,
        json_schema_extra={
...
class DifferentialOperator(ConfiguredBaseModel):
    ...
    operator_type: Optional[OperatorType] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["DifferentialOperator"]}}
    )
    coefficient: Optional[str] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["DifferentialOperator"]}}
    )
    tensor_coefficient: Optional[str] = Field(
        default=None,
        description="""Optional anisotropic tensor (e.g., diffusion).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["DifferentialOperator"]}},
    )
    expression: Optional[Equation] = Field(
        default=None,
...
class BoundaryCondition(ConfiguredBaseModel):
    ...
    bc_type: Optional[BoundaryConditionType] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["BoundaryCondition"]}}
    )
    on_region: Optional[str] = Field(
        default=None,
        description="""Mesh/atlas subset where BC applies.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["BoundaryCondition"]}},
    )
    value: Optional[Equation] = Field(
        default=None,
...
class PDESolver(ConfiguredBaseModel):
    ...
    discretization: Optional[DiscretizationMethod] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["BranchSwitch", "PDESolver"]}}
    )
    time_integrator: Optional[str] = Field(
        default=None,
        description="""e.g., implicit Euler, Crank-Nicolson.""",
        json_schema_extra={"linkml_meta": {"domain_of": ["PDESolver"]}},
    )
    dt: Optional[float] = Field(
        default=None, description="""Time step (s).""", json_schema_extra={"linkml_meta": {"domain_of": ["PDESolver"]}}
    )
    tolerances: Optional[str] = Field(
        default=None, description="""Abs/rel tolerances.""", json_schema_extra={"linkml_meta": {"domain_of": ["PDESolver"]}}
    )
...
class PDE(ConfiguredBaseModel):
    ...
    domain: Optional[SpatialDomain] = Field(
        default=None,
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["ClinicalScale", "ClinicalScore", "StateVariable", "Distribution", "Parameter", "PDE"]
    ...
    mesh: Optional[Mesh] = Field(
        ...
        json_schema_extra={"linkml_meta": {"domain_of": ["SpatialField", "FieldStateVariable", "PDE"]}},
    )
    state_variables: Optional[list[FieldStateVariable]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "PDE"]}}
    )
    field: Optional[SpatialField] = Field(
        default=None,
        description="""Primary field being solved for (deprecated; use state_variables).""",
        json_schema_extra={"linkml_meta": {"domain_of": ["PDE"]}},
    )
    operators: Optional[list[DifferentialOperator]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["PDE"]}}
    )
    sources: Optional[list[Equation]] = Field(default=None, json_schema_extra={"linkml_meta": {"domain_of": ["PDE"]}})
    boundary_conditions: Optional[list[BoundaryCondition]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["FieldStateVariable", "PDE"]}}
    )
    solver: Optional[PDESolver] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["InitialState", "PDE"]}}
    )
    derived_parameters: Optional[list[str]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "PDE"]}}
    )
    derived_variables: Optional[list[str]] = Field(
        default=None, json_schema_extra={"linkml_meta": {"domain_of": ["Dynamics", "PDE"]}}
    )
