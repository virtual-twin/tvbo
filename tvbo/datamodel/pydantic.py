...
""", json_schema_extra = { "linkml_meta": {'domain_of': ['GraphGenerator',
    ...
    parameters: Optional[dict[str, ParameterSpec]] = Field(default=None, description="""Declared generator parameters (e.g. n, k, p, seed), keyed by name.  Each declaration carries its datatype (``range``) and default; the backend ``bindings`` map names to the native constructor call.
...
class ParameterSpec(ConfiguredBaseModel):
    """
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'tvbo:ParameterSpec', 'from_schema': 'https://w3id.org/tvbo'})
    ...
    description: Optional[str] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['Dataset',
                       ...
                       'PDE'],
         'slot_uri': 'dcterms:description'} })
    range: Optional[str] = Field(default=None, description="""Datatype of the parameter (e.g. integer, string, uriorcurie, float).""", json_schema_extra = { "linkml_meta": {'domain_of': ['ParameterSpec']} })
    required: Optional[bool] = Field(default=True, description="""Whether the parameter must be supplied.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ParameterSpec'], 'ifabsent': 'boolean(true)'} })
    ifabsent: Optional[str] = Field(default=None, description="""Default value applied when the parameter is absent.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ParameterSpec']} })
