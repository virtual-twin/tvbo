...
class Function(ConfiguredBaseModel):
    ...
    arguments: Optional[list[str]] = Field(default=None, description="""Names of the variables consumed by the function (referenced in the equation). Bare-string list, e.g. arguments: [v].""", json_schema_extra = { "linkml_meta": {'domain_of': ['Function', 'FunctionCall', 'AlgorithmInclude']} })
