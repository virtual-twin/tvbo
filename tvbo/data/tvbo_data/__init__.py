...
# Atlases are consolidated under tvbo/database/atlases (the single source shared with
# networks, models, coordinate_spaces, …). ROOT is tvbo/data/tvbo_data, so the
# package root tvbo/ is two levels up. The legacy tvbo/data/tvbo_data/atlas copy is
# deprecated.
