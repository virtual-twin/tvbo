...
Exposes filesystem paths to the packaged data directories, notably the atlas and assignments folders, resolved relative to this module. Network and atlas
